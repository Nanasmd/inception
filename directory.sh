...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2024/05/30 12:10:41 by nasamadi          #+#    #+#              #
#    Updated: 2024/05/30 12:10:45 by nasamadi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
echo "DOMAIN_NAME=<intra_user>.42.fr" > inception/srcs/.env
echo "CERT_=./requirements/tools/<intra_user>.42.fr.crt" >> inception/srcs/.env
echo "KEY_=./requirements/tools/<intra_user>.42.fr.key" >> inception/srcs/.env
